...
export default function SurpriseMeModal() {
  ...
  return (
    ...
    >
      <div
        className="bg-card w-full max-w-4xl rounded-3xl shadow-hard border border-border overflow-hidden flex flex-col max-h-[80vh] mb-20 md:mb-0"
          ...
          {isLoading ? (
            ...
            >
              ...
              <div className="relative w-full h-64 md:h-auto md:min-h-[400px] rounded-2xl overflow-hidden shrink-0">
                ...
                <div className="absolute inset-0 bg-linear-to-br from-muted to-muted-foreground/20 flex items-center justify-center -z-10">
                  ...
                  <div className="flex flex-wrap gap-2" lang="en">
                    ...
                    {recipe.ingredients.length > 6 && (
                      <span className="px-3 py-1 bg-primary-500/10 text-primary-500 rounded-full text-sm font-medium">
                        {t("moreIngredients", {
                          count: recipe.ingredients.length - 6,
                        })}
                      </span>
                    )}
                  </div>
