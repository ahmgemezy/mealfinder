  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-card rounded-3xl shadow-2xl border border-border overflow-hidden transform transition-all scale-100 opacity-100">
        ...
        <div className="h-32 bg-linear-to-br from-primary-500 to-accent-500 relative overflow-hidden">
        ...
        <div className="p-8 text-center space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Sign in to save your favorite recipes, create collections, and
