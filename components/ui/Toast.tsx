...
import { useToast, type Toast as ToastType } from "@/lib/contexts/ToastContext";
...
const Toast = ({ toast }: { toast: ToastType }) => {
    ...
    return (
        <div
            className={`${getToastStyles()} rounded-lg p-4 mb-3 flex items-start gap-3 min-w-[300px] max-w-md transition-all duration-300 ${isExiting ? "opacity-0 translate-x-full" : "opacity-100 translate-x-0"
                }`}
            role="alert"
        >
