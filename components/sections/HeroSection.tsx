                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up animation-delay-200">
                        <Button
                            size="lg"
                            onClick={openModal}
                            className="w-full sm:w-auto bg-white text-primary-600 hover:bg-primary-50 shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 font-bold text-lg px-8 py-4 h-auto rounded-full"
                        >
