...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden min-h-[600px] flex items-center notranslate text-start">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-accent-500/20 rounded-full mix-blend-overlay filter blur-3xl opacity-30 motion-safe:animate-blob" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-primary-500/20 rounded-full mix-blend-overlay filter blur-3xl opacity-30 motion-safe:animate-blob animation-delay-2000" />
