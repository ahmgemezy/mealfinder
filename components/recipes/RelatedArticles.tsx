...
export default function RelatedArticles({ posts }: RelatedArticlesProps) {
    ...
    return (
        <section className="bg-gradient-to-br from-background to-muted py-16 border-t border-border/50">
                        ...
                        >
                            ...
                            <div className="p-6 flex flex-col flex-1">
                                <div className="text-xs text-muted-foreground mb-3 font-medium flex items-center gap-2">
                                    <span>{new Date(post.publishedDate).toLocaleDateString(locale, { month: 'short', day: 'numeric', year: 'numeric' })}</span>
                                    <span>•</span>
