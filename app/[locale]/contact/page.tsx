...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      "Get in touch with the Dish Shuffle team. We&apos;d love to hear your feedback, recipe suggestions, or partnership inquiries.",
    alternates: {
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:contact@dishshuffle.com"
